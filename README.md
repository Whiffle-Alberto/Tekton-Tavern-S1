...
Each release contains resourcepacks, shaders and mods.  
Only the recommended resourcepacks and shaderpacks are provided.  
You can remove/add more, in accordance with server rules.  
